...
library(brew)
```
# defined colors for UM scAtlas
## here are all colors for different conditions
```{r}
...
gender_col <- c("M" = "#58827EFF", "F" = "#611554FF", "unknown" = "#E1E1E1FF")
# ageGroup_col colors to discriminate between Young, Middle and Old age groups for GloScope Analysis
ageGroup_col <- c("Young" = "#9386A6FF", "Middle" = "#BFCDD9FF", "Old" = "#7F8C72FF")
# majority_celltype_col defines colors for major cell types (stored in majority_celltype)
majority_celltype_col <- c("Glial cells" = "#5A5156", "B/Plasma cells" = "lightslateblue", "Myeloid cells" = "lightblue", "T/NK cells" = "#325A9B", "Melanoma cells" = "#B00068", "Melanocytes" = "#C075A6", "Endothelial cells" = "chartreuse4", "Epithelial cells" = "#1CBE4F", "Fibroblasts" = "yellowgreen", "Mesenchymal cells" = "darkgreen", "Pericytes" = "olivedrab4", "Smooth muscle cells" = "#1CFFCE", "Photoreceptor cells" = "peachpuff3")
# tcell_col defines colors for t cell subtyping (stored in Subtyping)
tcell_col <- c("CD4_EM" = "#00366CFF", "CD4_EX" = "#004B84FF", "CD4_N" = "#00619FFF", "CD4_REG" = "#0077BCFF", "CD8_EM" = "#408DCEFF", "CD8_EMRA" = "#68A1DCFF", "CD8_EX" = "#88B4E8FF", "CD8_N" = "#A4C7F3FF", "CD8_RM" = "#BED7FBFF", "gdT" = "#D4E6FFFF", "NK_CYTO" = "#E8F2FFFF", "NK_REST" = "#F9F9F9FF", "Proliferating cells" = "#001889FF")
...
iCNV_colors <- c("Healthy" = "#ED8B58FF", "Malignant" = "#75005BFF", "Reference" = "#070707FF", "Other cells" = "#666879FF")
